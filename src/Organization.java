...
public class Organization {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Зарплата Олега по стандартным ставкам с двумя подчинёнными: " + oleg.salary());
        /*
         ...
         Сделать это можно в блоке обработки ошибок подчинённых в классе Grade.Senior
         */
        ManagerSenior dima = new ManagerSenior(0);
        System.out.println("Зарплата Димы по стандартным ставкам с автоподстановкой подчинённого: " + dima.salary());
        /*
         Решили мы вдруг за заслуги добавить Олегу ЗП, не вопрос
         */
        ((Developer) oleg.position).setRate(50000);
        System.out.println("Зарплата Олега c теми же двумя подчинёнными но с увеличенной зп: " + oleg.salary());
        ...
        System.out.println("Зарплата Димы все также автоисправление на одного подчинённого" +
                " и слегка увеличена ставка премии: " + dima.salary());
        /*
        ...
        System.out.println("Зарплата мидла манагера Маши: " + masha.salary());
        /*
        ...
        System.out.println("И вот Маша у нас получает зарплату разраба: " + masha.salary());
        /*
        ...
        System.out.println("И вот Маша получает свою заслуженную джуниорско-разрабческую зп: " + masha.salary());
        ...
        System.out.println("Зарплата Лобанова ни от чего не зависит, голые ставки: " + lobanov.salary());
        /*
        ...
        System.out.println("Зарплата Лобанова с по-царски поднятыми ставками: " + lobanov.salary());
    }
}
